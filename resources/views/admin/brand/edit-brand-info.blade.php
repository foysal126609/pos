...
@section('content')
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <form class="form-horizontal" name="editBranForm" action="{{url('/brand/update')}}" method="post">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label for="CategoryName" class="col-sm-2 control-label">Brand Name</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="{{$branInfoById->brand_name}}" name="brand_name" id="CategoryName" placeholder="Brand Name">
                                    <input type="hidden"  value="{{ $branInfoById->id }}" name="brand_id">
    ...
    <script>
        document.forms['editBranForm'].elements['publication_status'].value='{{$allBrandInfo->publication_status}}';
    </script>
